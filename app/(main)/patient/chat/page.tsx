...
export default function PatientChatPage() {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiClient.stream('/ai/chat', { message: input }, (chunk) => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-120px)] max-w-4xl mx-auto">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-white mb-2">HealthBrain AI Chat</h1>
        <p className="text-slate-400">
          Get personalized health insights and advice from our AI-powered healthcare assistant
        </p>
      </div>
          ...
          {messages.length === 0 && (
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                ...
                <p className="text-lg font-semibold text-white mb-2">Start Your Conversation</p>
                <p className="text-slate-400 max-w-xs">
                  Ask me anything about your health, symptoms, or wellness concerns
                </p>
              </div>
            </div>
          )}
        ...
        <div className="border-t border-slate-700 p-6 bg-slate-800/50">
          <form onSubmit={handleSendMessage} className="flex gap-3">
            <input
              ...
              placeholder="Ask HealthBrain anything..."
              disabled={isLoading}
